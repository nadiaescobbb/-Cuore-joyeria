  ...
  return (
    <section id="trust" className="bg-surface relative" ref={ref}>
      <div className="max-w-[1440px] mx-auto px-5 py-group md:px-20 text-center">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 lg:grid-cols-5 gap-10 md:gap-8 items-start text-center">
          {items.map((item, index) => (
            <div key={index} className="flex flex-col items-center">
              {item.icon}
              <h3 className="font-heading text-xl md:text-2xl font-normal text-foreground mb-2 md:mb-3">
                {item.title}
              </h3>
